...
function CreatePage() {
  ...
  let convertToUrl;
  if (!image.includes("https://")) convertToUrl = `https://${image}`;
  else convertToUrl = image;
  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center ">
        ...
        <div className="flex flex-col bg-slate-100 mx-2 rounded-xl items-center relative mb-5">
          <img
            src={convertToUrl}
            alt="instagram post"
